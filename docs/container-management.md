...
For detailed instructions on updating services that use the `infinite-drive` Docker image, see the [Updating the System](./update-system.md) guide.

This guide covers:
- Updating Git repository and Docker images
- Updating all services with the `node` prefix
- Troubleshooting update issues
- Ensuring persistent data remains safe during updates
